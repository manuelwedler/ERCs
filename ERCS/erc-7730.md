...
In the file name, trailing zero components of `<VERSION>` MAY be omitted; for example, version `2.0.0` is published as `erc7730-v2.schema.json`. The authoritative, full version is always the file's own `version` key.
...
To see the ERC text as it read for a specific released version, check out this repository at the commit noted for that version in the [Released versions](#released-versions) table below, or browse this file's git history directly.

#### Released versions

| Version      | Schema                                                                    | Commit ID                                  | Status     |
|--------------|---------------------------------------------------------------------------|----------------------------------------------|------------|
| `1.0.0`      | [`erc7730-v1.schema.json`](../assets/eip-7730/erc7730-v1.schema.json)     | `d42dfc9d0711b7175a24142b1e2c2d36e43ed8b7` | Deprecated |
| `2.0.0`      | [`erc7730-v2.schema.json`](../assets/eip-7730/erc7730-v2.schema.json)     | `2528d6a0cd463d7309464a33889774368ab52df3` | Active     |
| `3.0.0-next` | [`erc7730-v3.0.0-next.schema.json`](../assets/eip-7730/erc7730-v3.0.0-next.schema.json) | N/A | Draft |

Every version released from now on is added as a new row in this table, without altering the rows already present, and follows the `erc7730-v<VERSION>[-rc.<N>|-next].schema.json` file naming pattern described above.
